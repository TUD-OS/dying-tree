...
do
	...
	EXPORT="--export=DYING_LIST=$DYING_LIST,CORRT_DIST=$CORRT_DIST,CORRT_COUNT_MAX=$CORRT_COUNT_MAX,CORRT_DISS_TYPE=$CORRT_DISS_TYPE,TREE_LAME_K=$TREE_LAME_K,CORRT_GOSSIP_SEED=$CORRT_GOSSIP_SEED,CORRT_GOSSIP_ROUNDS=$CORRT_GOSSIP_ROUNDS,MPICH_SHARED_MEM_COLL_OPT=0"
